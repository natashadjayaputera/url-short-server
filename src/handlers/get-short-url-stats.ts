...
type GetShortUrlStatisticsResponseBody =
  | SuccessResponseBody<StatisticsResponseData>
  | FailResponseBody;

export default async function getShortUrlStatsHandler(
  req: Request<
    GetShortUrlStatisticsRequestPathParameters,
    GetShortUrlStatisticsResponseBody,
    never
  >,
